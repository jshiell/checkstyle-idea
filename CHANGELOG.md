...
* **26.15.0** New: Added a Refresh Results action, which rescans the selected results - or all results, if none are selected - and merges the outcome into the existing results (#1).
