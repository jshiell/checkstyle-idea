...
* **26.18.1** Fixed: Downloading a non-bundled Checkstyle version now honours a `<localRepository>` override in the user's Maven `settings.xml`, instead of always caching to `~/.m2/repository` (#706).
